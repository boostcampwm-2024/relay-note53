...
- 동일한 기능을 여러 방법으로 구현할 수 있을지 고민하기

-   Redme에 기존에 생각했던 방식과, 새롭게 생각한 방식 기록하기
...
-   수행 결과 :  3번: 모든 날에 함수명, 상수 등 의식하면서 관리했다. 특히 수/목 미션 개선하기에서 command 명령과 args를 상수로 빼서 관리했다. 
    ...
    ![image](https://github.com/user-attachments/assets/3c34c876-ad70-4fdd-b323-6a8c9898eb69)
...
-   **수행 경험 공유하기**
    ...
    학습정리에 온전히 기록은 못했지만 매일 스스로에게 금요일까지만 달리자 라는 얘기를 되새겼던 것 같습니다.
    오늘 보다 나은 내가 되자에 대한 부분은 어제보다 설계를 조금 더 꼼꼼히 라고 생각을 하고 했었는데 실제로 설계한거에 비해서는 개선하기에서 구현을 못한 것 같아 이렇게 남깁니다. (자료추가예정)
